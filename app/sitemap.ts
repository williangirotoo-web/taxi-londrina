...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    {
      url: url("/transporte-executivo-eventos-londrina"),
      lastModified: BUILD_DATE,
    ...
    {
      url: url("/private-driver-londrina"),
      lastModified: BUILD_DATE,
      changeFrequency: "monthly" as const,
      priority: 0.9,
    },
    {
      url: url("/executive-driver-londrina"),
      lastModified: BUILD_DATE,
      changeFrequency: "monthly" as const,
      priority: 0.9,
    },
    {
      url: url("/chauffeur-londrina"),
      lastModified: BUILD_DATE,
      changeFrequency: "monthly" as const,
      priority: 0.9,
    },
    {
      url: url("/transfer-aeropuerto-londrina"),
      lastModified: BUILD_DATE,
      changeFrequency: "monthly" as const,
      priority: 0.9,
    },
    {
      url: url("/chofer-ejecutivo-londrina"),
      lastModified: BUILD_DATE,
      changeFrequency: "monthly" as const,
      priority: 0.9,
    },
    {
      url: url("/transfer-londrina-guarulhos"),
      lastModified: BUILD_DATE,
      changeFrequency: "monthly" as const,
      priority: 0.9,
    },
    {
      url: url("/taxi-londrina-sao-paulo"),
      lastModified: BUILD_DATE,
      changeFrequency: "monthly" as const,
      priority: 0.9,
    },
    ...
    {
      url: url("/blog/aeroporto-londrina-gleba-palhano"),
      lastModified: BUILD_DATE,
      changeFrequency: "monthly" as const,
      priority: 0.7,
    },
